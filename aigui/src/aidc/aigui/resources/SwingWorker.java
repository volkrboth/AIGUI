...
public abstract class SwingWorker {
    ...
    public static HashMap<Object,Object> hmSem;
    ...
    public SwingWorker() {
        ...
        final Runnable doBeforeRun = new Runnable() {
            public void run() {
                if (ab != null)
                    ab.setEnabled(false);
            }
        };
        Gui.getInstance().registerSwingWorker(this);
        Runnable doConstruct = new Runnable() {
            public void run() {
                SwingUtilities.invokeLater(doBeforeRun);
                try {
                   
                    synchronized (SwingWorker.hmSem) {
                        setValue(construct());
                    }
